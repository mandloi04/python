class Aircraft:
    ...
    def instance_create(self):
        for i in range(len(instances)):
            ...
            if i==1: instances[i] = Aircraft(1,2)
            if i==2: instances[i] = Aircraft(4,12)
            if i==3: instances[i] = Aircraft(7,8)
            if i==4: instances[i] = Aircraft(13,29)
...
if __name__=='__main__':
    ...
    instances=["instance1", "instance2", "instance3", "instance4", "instance5"]
    for i in range(len(instances)):
        if i==0: instances[i] = Boeing_747(5,10,45,63)
        if i==1: instances[i] = Boeing_747(1,1,52,67)
        if i==2: instances[i] = Boeing_747(3,12,62,65)
        if i==3: instances[i] = Boeing_747(22,24,67,70)
        if i==4: instances[i] = Boeing_747(8,21,50,62)
